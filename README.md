...
**Pre-release status:** version 0.2.0-alpha.1 is experimental. The matching
JugglucoNG sender preset is being developed separately and is not part of an
upstream release yet. Live phone-to-Home-Assistant testing is still pending. Installing this integration alone does not enable data
